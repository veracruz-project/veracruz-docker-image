...
# [0e00.0000 0e0f.ffff] is reserved to early boot
CFG_TZDRAM_START ?= 0x0e100000
# The TZDRAM_SIZE is limited by the qemu/hw/arm/***REMOVED*** file, VIRT_SECURE_MEM value.
...
CFG_MAX_XLAT_TABLES = 32
//CFG_CORE_HEAP_SIZE ?= (1 * 1024 * 1024)
# When Secure Data Path is enable, last MByte of TZDRAM is SDP test memory.
CFG_TEE_SDP_MEM_SIZE ?= (4 * 1024 * 1024)
$(call force,CFG_DT,y)
CFG_DTB_MAX_SIZE ?= 0x100000
//CFG_TEE_RAM_VA_SIZE ?= (16 * 1024 * 1024)
endif
